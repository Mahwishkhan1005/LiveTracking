    ...
    try {
      ...
      if (paymentMethod === "ONLINE") {
        ...
        try {
          ...
          const errorMsg =
            paymentError.description || "Payment verification failed.";
    ...
    <View style={styles.cartCard}>
      ...
      <View style={styles.itemDetails}>
        ...
        <View style={styles.quantityContainer}>
          <TouchableOpacity
            onPress={() => updateQuantity(item.pid, -1)}
            style={styles.qtyBtn}
          >
            ...
            <View style={styles.paymentSection}>
              ...
              >
                <Ionicons
                  name="cash-outline"
                  size={24}
                  color={paymentMethod === "COD" ? "#2E8B57" : "#666"}
                />
                <Text
                  style={[
                    styles.methodText,
                    paymentMethod === "COD" && styles.activeMethodText,
                  ]}
                >
                  Cash on Delivery
                </Text>
              ...
              >
                <Ionicons
                  name="card-outline"
                  size={24}
                  color={paymentMethod === "ONLINE" ? "#2E8B57" : "#666"}
                />
                <Text
                  style={[
                    styles.methodText,
                    paymentMethod === "ONLINE" && styles.activeMethodText,
                  ]}
                >
